		...
		<div
			...
			<div className="flex flex-col md:flex-row items-center md:items-start md:gap-20">
                ...
                <div className="flex flex-col items-center md:items-start mt-10 text-gray-600">
                    ...
                    <p className="my-10 max-w-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Error voluptatum eos est labore nobis! Incidunt eaque repudiandae nulla harum totam quidem, quis, repellendus asperiores neque perferendis, aliquam minus dolores velit.</p>
